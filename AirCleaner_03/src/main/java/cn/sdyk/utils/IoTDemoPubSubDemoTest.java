...
//
//@Component(value="/ioTDemoPubSubDemo")
//public class IoTDemoPubSubDemoTest {
//    public static void main(String[] args) {
//       String a= monitor();
//        System.out.println(a);
//    }
//
//    public static String productKey="a1WDhGUACFn";
//    public static String deviceName="kfb_demo";
//    public static String deviceSecret="OgHF5GWOQo6IJWOFU21jRoaS2C84iesH";
...
//            // cn-shanghai
//            String targetServer = "tcp://" + productKey + ".iot-as-mqtt." + regionId + ".47.105.131.140:80";
//
//            System.out.println("targetServer" + targetServer);
//            String mqttclientId = clientId + "|securemode=3,signmethod=hmacsha1,timestamp=" + timestamp + "|";
//            String mqttUsername = deviceName + "&" + productKey;
//            String mqttPassword = AliyunIoTSignUtil.sign(params, deviceSecret, "hmacsha1");
//            System.out.println("id:"+mqttclientId);
//            System.out.println("账号name："+mqttUsername);
//            System.out.println("账号密码："+mqttPassword);
//
